...
public class SinglyLinkedList {
    ...
    public boolean remove(int index) {
        ...
        if (previous != null) previous.next = toBeRemoved.next;
        toBeRemoved = null;
        return true;
    }
    ...
    public static void main(String[] args) {
        ...
        singlyLinkedList.add("n");
        singlyLinkedList.add("a");
        singlyLinkedList.add("j");
        singlyLinkedList.add("u");
        singlyLinkedList.add("s");

        System.out.println(singlyLinkedList);

        System.out.println(reverse(singlyLinkedList, 0, singlyLinkedList.size() - 1));
    ...
    private static SinglyLinkedList reverse(SinglyLinkedList list, int i, int j) {
        if (i < j) {
