...
public class Graph {
    ...
    public int shortestPathLength(Vertex u, Vertex v) {
        ...
        return shortestPathLength.getShortestPathLength(u, v);
    }

    public List<Vertex> shortestPath(Vertex s, Vertex v) {
        ShortestPath shortestPath = new ShortestPath(this);

        return shortestPath.computeShortestPath(s, v);
    }
...
//		l.add(new Pair("H","F"));
        ...
        System.out.println("shortest path length " + g.shortestPathLength(new Vertex("A"), new Vertex("C")));

        System.out.println("shortest path " + g.shortestPath(new Vertex("B"), new Vertex("D")));
    }
}
