...
public class Graph {
    ...
    public boolean isConnected() {
        int combination = ((vertices.size() - 1) * (vertices.size() - 2)) / 2;
        return edges.size() > combination;
    }
    ...
    public boolean hasCycle() {
        return edges.size() > computeSpanningTree().edges.size();
    }
...
//		l.add(new Pair("H","F"));
        ...
        System.out.println(g.computeSpanningTree());
        System.out.println("Does Path exist? " + g.pathExists(new Vertex("A"), new Vertex("D")));
