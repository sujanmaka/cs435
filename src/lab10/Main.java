...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Is C reachable from B? " + g.reaches(b, c));
		System.out.println("Is B reachable from C? " + g.reaches(c, b));
		System.out.println("Is B reachable from D? " + g.reaches(d, b));
		System.out.println("All vertices reachable from B: " + g.reachable(a));
