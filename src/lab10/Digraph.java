...
public class Digraph {
    ...
    /* For any vertex v, lists the vertices w for which (v,w) is an edge */ HashMap<Vertex, LinkedList<Vertex>> outList = new HashMap<Vertex, LinkedList<Vertex>>();

    /* For any vertex v, lists the vertices w for which (w,v) is an edge */ HashMap<Vertex, LinkedList<Vertex>> inList = new HashMap<Vertex, LinkedList<Vertex>>();
     ...
     */
    public boolean reaches(Vertex s, Vertex v) {
        //implement
        Reaches reaches = new Reaches(this);
        return reaches.isReachable(s, v);
    }

    /**
     * Returns a list of vertices reachable from a given vertex
     */
    public List<Vertex> reachable(Vertex s) {
        //implement
        Reachable reachable = new Reachable(this);
        return reachable.getReachableVertices(s);
    }
